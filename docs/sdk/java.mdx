...
## Introduction
The [TraceRoot Java SDK](https://github.com/traceroot-ai/traceroot-sdk-java) is a lightweight wrapper around OpenTelemetry and different logging libraries, optimized for ease of use.
