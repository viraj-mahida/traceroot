...
## Introduction
The [TraceRoot TypeScript SDK](https://www.npmjs.com/package/traceroot-sdk-ts) is a lightweight wrapper around OpenTelemetry, optimized for ease of use.
...
## Environment Setup
Create an [TraceRoot token](https://test.traceroot.ai/integrate) from the dashboard.
